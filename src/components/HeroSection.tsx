...
const HeroSection = () => {
  return (
    <section className="flex items-center gap-[49px] self-stretch relative lg:flex-row flex-col max-lg:gap-10 max-sm:items-center max-sm:gap-[30px]">
      <div className="flex w-full lg:w-[580px] flex-col items-start gap-12 relative max-lg:max-w-[600px] max-sm:gap-[30px] max-sm:items-center max-sm:text-center order-1">
